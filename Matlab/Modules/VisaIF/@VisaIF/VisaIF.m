classdef VisaIF < handle
    ...
    properties(Constant = true)
        SupportedInstrumentClasses = { ...
            'FGen'              ...    % used by FGen class
            'Scope'             ...    % used by Scope class
            'DCPwr'             ...    % in preparation
            'ACPwr'             ...
            'PwrMeter'          ...
            'SpecAn'            ...    % in preparation
            'RFSigGen'          ...
            'DownCnv'           ...
            'UpConv'            ...
            'Swtch'             ...
            ...
            'Digitizer'         ...
            'Counter'           ...
            'SMU24xx'           ...    % used by SMU24xx class
            'Other'             };     % placeholder for development
